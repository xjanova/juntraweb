...
class ChatPolicy
{
    ...
    /**
     * เพดานข้อความฟรีต่อคนต่อวัน — Setting 'chat_daily_limit' (0 = ไม่จำกัด)
     *
     ...
     *
     * ถ้าต้นทุน AI บานปลายในอนาคต ตั้งค่านี้เป็นตัวเลขได้ทันทีโดยไม่ต้องแก้โค้ด
     * (มีผลทั้งเว็บและแอพพร้อมกันเพราะอ่านจาก ChatPolicy ที่เดียว)
     *
