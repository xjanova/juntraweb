...
class ChatTopupController extends Controller
{
     ...
     *
     * กติกาจริงอยู่ใน SlipAutoVerifier เพราะ API มือถือต้องใช้ชุดเดียวกันเป๊ะ
     * (เส้นทางนี้แตะเงิน ถ้ามีสองชุดจะ drift แน่นอน)
     *
    ...
    {
        $result = $this->slips->verify($tx, $user, $path);
        if ($result === null) {
            return null;
        }
